class Droid < Formula
  ...
  url "http://www.nationalarchives.gov.uk/documents/information-management/droid-binary-6.3-bin.zip"
  ...
  def install
    ...
    inreplace "droid.sh" do |s|
      s.gsub! "droid-command-line-6.2.1.jar", "#{libexec}/droid-command-line-6.3.jar"
      s.gsub! "droid-ui-6.2.1.jar", "#{libexec}/droid-ui-6.3.jar"
    end
